...
const baseTranslations: TranslationDict = {
  ...
  stocks_add: 'Hinzufügen',
  stocks_interval_label: 'Aktualisierungsintervall (Sekunden)',
  stocks_interval_hint: 'Höheres Intervall reduziert Rate-Limits. Empfohlen: 120s+',
  ...
  stocks_retry_in: 'Nächster Versuch in',
  stocks_last_updated: 'Zuletzt aktualisiert',
  stocks_as_of: 'Stand',
  stocks_refresh: 'Aktualisieren',
  layouts_description: 'Speichere und lade Dashboard-Layouts lokal. Änderungen werden nicht online gespeichert.',
  layouts_save: 'Speichern',
  layouts_load: 'Laden',
  layouts_delete: 'Löschen',
  ...
  layouts_import_placeholder: 'JSON-Layout hier einfügen',
  layouts_import_error: 'Import fehlgeschlagen – gültiges JSON nötig',
  ...
  layouts_deleted_success: 'Layout gelöscht',
  layouts_select_prompt: 'Bitte ein Layout auswählen',
  ...
  pomodoro_minty_break: 'Minty: Zeit zum Durchatmen 🍃',
  ...
  ambient_mixer: 'Mixer',
  ambient_add_files_hint: 'Füge .mp3-Dateien in',
  upcoming_loading: 'Lädt...',
  ...
  upcoming_add: 'Hinzufügen',
  upcoming_empty_past: 'Keine vergangenen Einträge',
  upcoming_empty_upcoming: 'Keine kommenden Einträge',
  ...
  upcoming_category_personal: 'Persönlich',
  ...
  news_add_feed: 'Quelle hinzufügen',
  news_feed_name: 'Name',
  ...
  news_validation_duplicate: 'IDs müssen eindeutig sein',
  ...
  weather_settings_description: 'Lege die Koordinaten für das Wetter-Widget fest.',
  weather_settings_latitude: 'Breitengrad (Latitude)',
  weather_settings_longitude: 'Längengrad (Longitude)',
  ...
  weather_settings_invalid: 'Bitte gültige Koordinaten eingeben',
  ...
  calendar_empty: 'Keine Termine in den nächsten Tagen.',
  calendar_event_count: 'Termin(e)',
  calendar_all_day: 'Ganztägig',
  calendar_settings_description: 'Wähle, an welchem Tag die Woche startet.',
  ...
  restart_hint: 'Startet den Server-Prozess neu und lädt die Seite neu.',
  widget_pin: 'Anpinnen',
  widget_unpin: 'Lösen',
  transparency_mode_title: 'Transparenz-Modus',
  transparency_mode_hint: 'Schalte aus für volle Deckkraft. Schalte ein für echte Alpha-Transparenz.',
  transparency_on: 'An',
  transparency_off: 'Aus',
  transparency_title: 'Hintergrund-Transparenz',
  transparency_hint: '0% = vollständig transparent, 100% = vollständig opak',
...
const translations: Record<Language, Partial<TranslationDict>> = {
  ...
  en: {
    ...
    layouts_import_error: 'Import failed – provide valid JSON',
    ...
    pomodoro_sessions_word: 'sessions',
    pomodoro_minty_work: 'Minty: Let’s go!',
    pomodoro_minty_break: 'Minty: Time to breathe 🍃',
  ...
  es: {
    ...
    widget_systemPet: 'Minty',
    widget_musicPlayer: 'Música',
    widget_ambientSound: 'Sonidos ambiente',
    widget_upcoming: 'Próximos',
    widget_rabbitHole: 'Rabbit Hole',
    widget_news: 'Noticias',
    widget_weather: 'Tiempo',
    widget_calendar: 'Calendario',
    widget_tasks: 'Tareas y notas',
    widget_system: 'Métricas del sistema',
    widget_pomodoro: 'Temporizador Pomodoro',
    stocks_description: 'Gestiona tu lista de seguimiento.',
    stocks_placeholder: 'Símbolo (p.ej. AAPL)',
    stocks_add: 'Añadir',
    stocks_interval_label: 'Intervalo de actualización (segundos)',
    stocks_interval_hint: 'Un intervalo mayor evita límites de uso. Recomendado: 120s+',
    stocks_empty: 'No hay acciones configuradas',
    stocks_empty_watchlist: 'Ninguna acción en la lista',
    stocks_loading: 'Cargando cotizaciones...',
    stocks_error: 'Error al cargar cotizaciones',
    stocks_using_cache: 'Mostrando datos en caché',
    stocks_using_fallback: 'Mostrando datos alternativos (offline)',
    stocks_retry_in: 'Reintentando en',
    stocks_last_updated: 'Última actualización',
    stocks_as_of: 'Actualizado',
    stocks_refresh: 'Actualizar',
    layouts_description: 'Guarda y carga los layouts del panel de forma local. No se guardan en línea.',
    ...
    layouts_import_placeholder: 'Pega aquí el JSON del layout',
    layouts_import_error: 'Error al importar: JSON no válido',
    ...
    pomodoro_minty_break: 'Minty: Hora de respirar 🍃',
    ...
    system_loading: 'Cargando métricas...',
    ...
    upcoming_tab_upcoming: 'Próximos',
    upcoming_tab_past: 'Pasados',
    upcoming_title_placeholder: 'Título',
    ...
    upcoming_empty_upcoming: 'Sin entradas próximas',
    upcoming_category_tech: 'Tecnología',
    ...
    news_validation_duplicate: 'Las IDs deben ser únicas',
    ...
    weather_settings_location: 'Ubicación',
    weather_settings_location_placeholder: 'p. ej. Viena',
    weather_settings_unit: 'Unidad',
    weather_settings_unit_c: 'Celsius (°C)',
    weather_settings_unit_f: 'Fahrenheit (°F)',
    weather_location_missing: 'Ubicación no configurada',
    ...
    weather_settings_invalid: 'Introduce coordenadas válidas',
    ...
    tasks_error_generic: 'Acción fallida',
    ...
    calendar_empty: 'Sin eventos en los próximos días.',
    calendar_event_count: 'evento(s)',
    calendar_all_day: 'Todo el día',
    calendar_settings_description: 'Elige el día en que comienza la semana.',
    calendar_week_start_label: 'Primer día de la semana',
  ...
  sr: {
    ...
    stocks_add: 'Dodaj',
    stocks_interval_label: 'Interval osvežavanja (sekunde)',
    stocks_interval_hint: 'Veći interval smanjuje ograničenja. Preporuka: 120s+',
    stocks_empty: 'Nema podešenih akcija',
    stocks_empty_watchlist: 'Lista akcija je prazna',
    stocks_loading: 'Učitavanje cena...',
    stocks_error: 'Greška pri učitavanju cena',
    stocks_using_cache: 'Prikaz keširanih cena',
    stocks_using_fallback: 'Prikaz rezervnih podataka (offline)',
    stocks_retry_in: 'Ponovni pokušaj za',
    stocks_last_updated: 'Poslednje osvežavanje',
    stocks_as_of: 'Ažurirano',
    stocks_refresh: 'Osveži',
    layouts_description: 'Sačuvaj i učitaj rasporede table lokalno. Ništa se ne šalje na mrežu.',
    layouts_save: 'Sačuvaj',
    layouts_load: 'Učitaj',
    layouts_delete: 'Obriši',
    layouts_refresh: 'Osveži',
    ...
    layouts_import_error: 'Uvoz neuspešan – neispravan JSON',
    layouts_imported: 'Raspored uvezen',
    layouts_name_placeholder: 'Naziv rasporeda',
    layouts_none: 'Nema sačuvanih rasporeda',
    layouts_current_layout: 'Trenutni raspored',
    layouts_saved_success: 'Raspored sačuvan',
    layouts_loaded_success: 'Raspored učitan',
    layouts_deleted_success: 'Raspored obrisan',
    layouts_select_prompt: 'Izaberi raspored',
    layouts_load_error: 'Raspored nije moguće učitati',
    theme_label: 'Tema',
    theme_dark: 'Tamna',
    theme_light: 'Svetla',
    language_label: 'Jezik',
    language_german: 'Nemački',
    language_english: 'Engleski',
    language_spanish: 'Španski',
    ...
    pomodoro_minty_break: 'Minty: Vreme za predah 🍃',
    ...
    system_loading: 'Učitavam metrike...',
    system_connecting: 'Povezujem se sa backendom...',
    system_cpu: 'CPU',
    system_memory: 'Memorija',
    system_disk: 'Disk',
    system_network: 'Mreža',
    system_uptime: 'Vreme rada',
    ambient_sound_rain: 'Kiša',
    ambient_sound_forest: 'Šuma',
    ambient_sound_cafe: 'Kafić',
    ambient_sound_fireplace: 'Kamin',
    ambient_sound_ocean: 'Okean',
    ambient_sound_wind: 'Vetar',
    ambient_sound_thunder: 'Oluja',
    ambient_sound_whitenoise: 'Beli šum',
    ambient_active_count: 'Aktivno: {count}',
    ambient_none_active: 'Ništa aktivno',
    ambient_stop_all: 'Zaustavi sve',
    ambient_file_missing: 'Fajl nije pronađen',
    ambient_mixer: 'Mikser',
    ambient_add_files_hint: 'Dodaj .mp3 fajlove u',
    upcoming_loading: 'Učitavanje...',
    upcoming_tab_upcoming: 'Predstojeće',
    upcoming_tab_past: 'Prošlo',
    upcoming_title_placeholder: 'Naslov',
    upcoming_url_placeholder: 'URL (opciono)',
    upcoming_cancel: 'Otkaži',
    upcoming_save: 'Sačuvaj',
    upcoming_add: 'Dodaj',
    upcoming_empty_past: 'Nema prošlih unosa',
    upcoming_empty_upcoming: 'Nema predstojećih unosa',
    ...
    upcoming_category_personal: 'Lično',
    news_loading: 'Učitavanje vesti...',
    news_error: 'Greška pri učitavanju vesti',
    news_empty: 'Nema članaka',
    news_settings_description: 'Upravljaj izvorima vesti, širinom i redosledom.',
    news_colspan: 'Kolone',
    news_no_feeds: 'Nema podešenih izvora vesti.',
    ...
    news_save: 'Sačuvaj',
    news_saving: 'Čuvam...',
    news_save_success: 'Izvori sačuvani',
    news_test_feed: 'Testiraj izvor',
    news_test_success: 'Feed uspešno testiran',
    ...
    weather_loading: 'Učitavanje vremena...',
    weather_error: 'Neuspešno učitavanje prognoze',
    weather_no_data: 'Nema podataka',
    weather_feels_like: 'Oseća se kao',
    weather_humidity: 'Vlažnost',
    weather_wind: 'Vetar',
    weather_rain: 'Kiša',
    weather_unknown_error: 'Nepoznata greška',
    weather_settings_description: 'Podesi koordinate za vremenski widget.',
    weather_settings_latitude: 'Geografska širina',
    weather_settings_longitude: 'Geografska dužina',
    weather_settings_location: 'Lokacija',
    weather_settings_location_placeholder: 'npr. Beč',
    weather_settings_unit: 'Jedinica',
    weather_settings_unit_c: 'Celsius (°C)',
    weather_settings_unit_f: 'Fahrenheit (°F)',
    weather_location_missing: 'Lokacija nije podešena',
    weather_settings_save: 'Sačuvaj',
    weather_settings_test: 'Testiraj',
    weather_settings_testing: 'Testiram...',
    weather_settings_saved: 'Sačuvano',
    weather_settings_invalid: 'Unesi važeće koordinate',
    weather_settings_test_success: 'Podaci o vremenu učitani',
    tasks_loading: 'Učitavanje...',
    tasks_placeholder: 'Novi zadatak...',
    tasks_add: 'Dodaj',
    tasks_empty: 'Nema otvorenih zadataka.',
    tasks_delete: 'Obriši',
    tasks_error_loading: 'Ne mogu da učitam zadatke/bilješke',
    tasks_error_generic: 'Akcija neuspešna',
    notes_placeholder: 'Brza beleška...',
    notes_save: 'Sačuvaj',
    notes_empty: 'Nema beležaka.',
    notes_delete: 'Obriši',
    calendar_loading: 'Učitavanje događaja...',
    calendar_error: 'Kalendarski podaci nisu dostupni',
    calendar_empty: 'Nema događaja u narednim danima.',
    calendar_event_count: 'događaj(a)',
    calendar_all_day: 'Ceo dan',
    calendar_settings_description: 'Izaberi dan kada počinje nedelja.',
    ...
    restart_frontend: 'Osveži frontend',
    restart_running: 'Restartujem...',
    restart_failed: 'Restart neuspešan',
